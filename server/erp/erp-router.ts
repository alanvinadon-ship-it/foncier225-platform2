...
import { erpInvoicesRouter } from "./erp-invoices-router";
...
import { erpSolarTemplatesRouter } from "./erp-solar-templates-router";
...
export const erpRouter = router({
  ...
  solarTemplates: erpSolarTemplatesRouter,
});
