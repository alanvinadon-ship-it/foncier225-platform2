...
export const userAdminProcedures = {
  ...
  createUser: adminProcedure
    .input(z.object({
      ...
      role: z.enum(["citizen", "agent_terrain", "agent_mclu", "geometre_urbain", "conservateur", "notaire", "agent_dgi", "autorite_prefectorale", "agent_afor", "comite_villageois", "bank", "admin"]),
    }))
  ...
  updateUserDetails: adminProcedure
    .input(z.object({
      ...
      role: z.enum(["citizen", "agent_terrain", "agent_mclu", "geometre_urbain", "conservateur", "notaire", "agent_dgi", "autorite_prefectorale", "agent_afor", "comite_villageois", "bank", "admin"]).optional(),
