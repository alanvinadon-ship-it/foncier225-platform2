...
export const erpSolarPriceCatalog = mysqlTable("erp_solar_price_catalog", {
  ...
  brand: varchar("brand", { length: 128 }),
  model: varchar("model", { length: 128 }),
  qualityLevel: varchar("quality_level", { length: 32 }),
  recommendedUsage: varchar("recommended_usage", { length: 64 }),
...
export const erpSolarDesignInputs = mysqlTable("erp_solar_design_inputs", {
  ...
  batterySizingMode: varchar("battery_sizing_mode", { length: 32 }).notNull().default("total_load"),
  hybridBackupPercent: decimal("hybrid_backup_percent", { precision: 4, scale: 2 }).default("0.30"),
  pvStringVoltageV: int("pv_string_voltage_v"),
  batteryAgeingFactor: decimal("battery_ageing_factor", { precision: 4, scale: 2 }).notNull().default("0.80"),
  batteryTemperatureFactor: decimal("battery_temperature_factor", { precision: 4, scale: 2 }).notNull().default("0.95"),
  batteryReserveMarginPercent: decimal("battery_reserve_margin_percent", { precision: 4, scale: 2 }).notNull().default("0.10"),
  powerFactor: decimal("power_factor", { precision: 4, scale: 2 }).notNull().default("0.85"),
  inverterSurgeMargin: decimal("inverter_surge_margin", { precision: 4, scale: 2 }).notNull().default("0.10"),
  pvMarginPercent: decimal("pv_margin_percent", { precision: 4, scale: 2 }).notNull().default("0.15"),
  createdAt: bigint("created_at", { mode: "number" }).notNull(),
  updatedAt: bigint("updated_at", { mode: "number" }).notNull(),
});
...
export const erpSolarSizingResults = mysqlTable("erp_solar_sizing_results", {
  ...
  simultaneousPowerW: decimal("simultaneous_power_w", { precision: 12, scale: 2 }),
  maxStartupPowerW: decimal("max_startup_power_w", { precision: 12, scale: 2 }),
  realisticPeakPowerW: decimal("realistic_peak_power_w", { precision: 12, scale: 2 }),
  totalDailyEnergyWh: decimal("total_daily_energy_wh", { precision: 12, scale: 2 }),
  criticalDailyEnergyWh: decimal("critical_daily_energy_wh", { precision: 12, scale: 2 }),
  nightDailyEnergyWh: decimal("night_daily_energy_wh", { precision: 12, scale: 2 }),
  // PV
  detailedEfficiency: decimal("detailed_efficiency", { precision: 6, scale: 4 }),
  pvGrossPowerWc: decimal("pv_gross_power_wc", { precision: 12, scale: 2 }),
  pvRecommendedPowerWc: decimal("pv_recommended_power_wc", { precision: 12, scale: 2 }),
  ...
  pvInstalledPowerWc: decimal("pv_installed_power_wc", { precision: 12, scale: 2 }),
  pvRealMarginPercent: decimal("pv_real_margin_percent", { precision: 6, scale: 4 }),
  // Batterie
  batterySizingMode: varchar("battery_sizing_mode", { length: 32 }),
  batteryReferenceEnergyWh: decimal("battery_reference_energy_wh", { precision: 12, scale: 2 }),
  batteryNominalCapacityWh: decimal("battery_nominal_capacity_wh", { precision: 12, scale: 2 }),
  batteryRecommendedCapacityWh: decimal("battery_recommended_capacity_wh", { precision: 12, scale: 2 }),
  ...
  batteryModulesCount: int("battery_modules_count"),
  batteryRealAutonomyDays: decimal("battery_real_autonomy_days", { precision: 6, scale: 2 }),
  // Onduleur
  inverterMinPowerW: decimal("inverter_min_power_w", { precision: 12, scale: 2 }),
  inverterContinuousRecommendedW: decimal("inverter_continuous_recommended_w", { precision: 12, scale: 2 }),
  inverterSurgeRequiredW: decimal("inverter_surge_required_w", { precision: 12, scale: 2 }),
  inverterPowerKva: decimal("inverter_power_kva", { precision: 12, scale: 2 }),
  recommendedInverterPowerW: decimal("recommended_inverter_power_w", { precision: 12, scale: 2 }),
  // Pertes
  totalCableLossW: decimal("total_cable_loss_w", { precision: 10, scale: 2 }),
  totalCableLossWhDay: decimal("total_cable_loss_wh_day", { precision: 10, scale: 2 }),
  // Meta
...
export const erpSolarCableSizing = mysqlTable("erp_solar_cable_sizing", {
  ...
  fromEquipment: varchar("from_equipment", { length: 128 }),
  toEquipment: varchar("to_equipment", { length: 128 }),
  voltageV: decimal("voltage_v", { precision: 8, scale: 2 }),
  powerW: decimal("power_w", { precision: 10, scale: 2 }),
  ...
  selectedSectionMm2: decimal("selected_section_mm2", { precision: 6, scale: 1 }).notNull(),
  recommendedCommercialSectionMm2: decimal("recommended_commercial_section_mm2", { precision: 6, scale: 1 }).notNull(),
  voltageDropV: decimal("voltage_drop_v", { precision: 8, scale: 4 }),
  voltageDropPercent: decimal("voltage_drop_percent", { precision: 6, scale: 3 }),
  resistanceOhm: decimal("resistance_ohm", { precision: 8, scale: 4 }),
  powerLossW: decimal("power_loss_w", { precision: 10, scale: 2 }),
  energyLossWhDay: decimal("energy_loss_wh_day", { precision: 10, scale: 2 }),
  lossPercent: decimal("loss_percent", { precision: 6, scale: 3 }),
  ampacityLimitA: decimal("ampacity_limit_a", { precision: 8, scale: 2 }),
  ampacityStatus: varchar("ampacity_status", { length: 32 }).default("OK"),
  protectionRecommendation: varchar("protection_recommendation", { length: 255 }),
  engineeringStatus: varchar("engineering_status", { length: 32 }).notNull().default("Draft"),
...
// Table de référence ampacité câbles (intensités admissibles)
export const erpSolarCableAmpacity = mysqlTable("erp_solar_cable_ampacity", {
  id: int("id").primaryKey().autoincrement(),
  sectionMm2: decimal("section_mm2", { precision: 6, scale: 1 }).notNull(),
  material: varchar("material", { length: 32 }).notNull().default("copper"),
  installMethod: varchar("install_method", { length: 64 }).notNull().default("conduit"),
  conductorCount: int("conductor_count").notNull().default(2),
  ampacityA: decimal("ampacity_a", { precision: 8, scale: 2 }).notNull(),
  temperatureRatingC: int("temperature_rating_c").notNull().default(70),
  standard: varchar("standard", { length: 64 }).notNull().default("NF C 15-100"),
  createdAt: bigint("created_at", { mode: "number" }).notNull(),
  updatedAt: bigint("updated_at", { mode: "number" }).notNull(),
});

// Table alertes techniques solaire
export const erpSolarTechnicalAlerts = mysqlTable("erp_solar_technical_alerts", {
  id: int("id").primaryKey().autoincrement(),
  solarProjectId: int("solar_project_id").notNull(),
  alertCategory: varchar("alert_category", { length: 64 }).notNull(),
